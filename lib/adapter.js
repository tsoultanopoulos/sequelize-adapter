...
class SequelizeAdapter {
    ...
    open() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.CasbinRule = (0, casbinRule_1.createCasbinRule)(this.option.tableName, this.option.schema); // Set the property here
    ...
    loadPolicy(model) {
        return __awaiter(this, void 0, void 0, function* () {
            const lines = yield this.sequelize.getRepository(this.CasbinRule).findAll();
    ...
    savePolicy(model) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.sequelize.transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.CasbinRule.bulkCreate(lines.map((l) => l.get({ plain: true })), { transaction: tx });
            }));
            return true;
        });
    }
    ...
    removePolicy(sec, ptype, rule) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.sequelize.getRepository(this.CasbinRule).destroy({ where });
        });
    }
    /**
     * removePolicies removes a policyList rule from the storage.
    ...
    removeFilteredPolicy(sec, ptype, fieldIndex, ...fieldValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.sequelize.getRepository(this.CasbinRule).destroy({
                where,
            });
        });
    }
